...
diff $txtfile $txtfile && echo "✅ Arquivo extraído igual ao original!" || echo "❌ Diferença encontrada!"
sleep 1
...
dd if=/dev/zero of=move4.bin bs=1 count=1024 status=none
$VC -ip $VCFILE move2.bin move3.bin move4.bin
sleep 1
$VC -c $VCFILE
sleep 1

# Etapa 13: move 4 -> 2 e lista
echo ">> Movendo move4.bin antes de move2.bin"
$VC -m $VCFILE move2.bin move4.bin
sleep 1
$VC -c $VCFILE
sleep 1

# Etapa 14: move 2 -> 3 e lista
echo ">> Movendo move2.bin antes de move3.bin"
$VC -m $VCFILE move3.bin move2.bin
sleep 1
$VC -c $VCFILE
sleep 1
...
echo ">> Removendo tudo..."
$VC -r $VCFILE $txtfile move2.bin move3.bin move4.bin
sleep 1
$VC -c $VCFILE
sleep 1
